...
import { useDepartments } from "./firebase/useDepartments";   // ← new
...
import DepartmentsPage from "./pages/departments/DepartmentsPage";  // ← new
...
export default function App() {
  ...
  const { departments,  loading: loadDept, addDepartment, updateDepartment, deleteDepartment } = useDepartments(); // ← new
  ...
  const sharedProps = {
    user,
    employees, kpis, leaves, payroll, leaveBalances, departments,  // ← departments added
    addEmployee, updateEmployee, deleteEmployee,
    addKpi, updateKpi,
    addLeave, updateLeaveStatus,
    addPayroll, updatePayrollStatus,
    addDepartment, updateDepartment, deleteDepartment,              // ← department CRUD added
  };
  ...
  return (
    <Layout user={user} page={page} setPage={setPage} onLogout={onLogout}>
      ...
      {page === "departments" && isAdminOrHR             && <DepartmentsPage {...sharedProps} />}  {/* ← new */}

...
import { AUTH_ROLE_STORAGE_KEY, useAuthSession } from "../hooks/useAuthSession";
...
const LEGACY_AUTH_ROLE_STORAGE_KEY = "sigma-selected-role";
...
export function AppProvider({ children }) {
  ...
  const logout = useCallback(() => {
    ...
    sessionStorage.removeItem(LEGACY_AUTH_ROLE_STORAGE_KEY);
    return signOutUser();
  }, []);
